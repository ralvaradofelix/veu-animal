...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">  
        <ol class="breadcrumb">
            <li><a href="diapositivas-list.php">diapositivas</a></li>
...
include("_generate/diapositivas_actiu.php");

$labels["title"] = "Title";

include("_generate/diapositivas_title.php");
 ?>
