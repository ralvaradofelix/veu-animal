...
if (isset($_POST['accio']) && $_POST['accio'] == "guardar")
{
    ...
    if(! count($errors)) {
            $obj['actiu'] = 1;
            $model->save($obj);
            header("Location: animalphoto-list.php" );
    }
...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">  
        <ol class="breadcrumb">
            <li><a href="animalphoto-list.php">animalphoto</a></li>
...
<input type="hidden" name="accio" value="guardar" />
    <?php 
$labels["id_animal"] = "Id_animal";

include("_generate/animalphoto_id_animal.php");

$labels["posicio"] = "Posicio";

include("_generate/animalphoto_posicio.php");

$labels["image"] = "Image";

include("_generate/animalphoto_image.php");
 ?>
